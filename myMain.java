...
public class myMain {
	...
	public static int extra04(myList<String> l, String word, int index, int accum){
		if(l.my_get_length() == 0) {
			...
			String a = l.my_get_element(0);
			l.my_remove_element(0);
			accum = extra04(l, word,index, accum);
			if(a.equals(word)) {
				accum++;
			}
		}
